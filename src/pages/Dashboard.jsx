...
const SkeletonKpi = () => (
  <div className="ref-kpi-card ref-kpi-card--skeleton" aria-hidden>
    ...
    <div className="ref-kpi-skel-body">
      ...
      <span className="skeleton skeleton-pulse ref-kpi-skel-line ref-kpi-skel-line--hint" />
    </div>
  </div>
)
  ...
  return (
    ...
    <div className="dashboard-container dashboard-page ref-dashboard app-horizon-shell">
      <div className="app-horizon-inner">
        ...
        <header className="ref-dashboard-header">
          ...
          <div className="ref-dashboard-header__actions">
            ...
            <a
              ...
              title={whatsappContactUrl ? 'WhatsApp' : 'Configure VITE_WHATSAPP_LINK ou VITE_WHATSAPP_PHONE'}
              onClick={(e) => {
                if (!whatsappContactUrl) e.preventDefault()
              }}
            >
        ...
        <section className="ref-kpi-row" aria-label="Resumo financeiro" aria-busy={loading}>
          {loading ? (
            <>
              <SkeletonKpi />
              <SkeletonKpi />
            ...
            <>
              <article className="ref-kpi-card ref-kpi-card--balance ref-kpi-card--hero">
                ...
                <div className="ref-kpi-card__body">
                  ...
                  <p className="ref-kpi-card__hint">Soma de todas as transações</p>
                </div>
              </article>
              <article className="ref-kpi-card ref-kpi-card--expense">
                ...
                <div className="ref-kpi-card__body">
                  ...
                  <p className="ref-kpi-card__hint">Total de despesas registradas</p>
                </div>
              </article>
              <article className="ref-kpi-card ref-kpi-card--income">
                ...
                <div className="ref-kpi-card__body">
                  ...
                  <p className="ref-kpi-card__hint">Total de receitas registradas</p>
                </div>
              </article>
            </>
          )}
