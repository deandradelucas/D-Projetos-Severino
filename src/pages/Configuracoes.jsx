      ...
      fetch('/api/usuarios/perfil', {
        ...
        .then((data) => {
          if (data.perfil?.telefone) {
            setTelefoneCadastro(data.perfil.telefone)
          }
        })
                ...
                {telefoneCadastro ? (
                  <>
                    <p style={{ margin: '8px 0 0 0', fontSize: '14px', color: 'var(--text-secondary)' }}>
                      Telefone da conta (cadastro): <strong style={{ color: 'var(--text-primary)' }}>{telefoneCadastro}</strong>
                    </p>
                    <p style={{ margin: '6px 0 0 0', fontSize: '12px', color: 'var(--text-secondary)', lineHeight: 1.45 }}>
                      O bot do WhatsApp usa <strong>só este número</strong> para vincular despesas e receitas à sua conta.
                    </p>
                  </>
                ) : (
                  <p style={{ margin: '8px 0 0 0', fontSize: '13px', color: 'var(--text-secondary)' }}>
                    Nenhum telefone no cadastro. Inclua o número ao <strong>criar a conta</strong> para o bot reconhecer suas mensagens.
                  </p>
                )}
              </div>
            </div>
