...
export default function AuthPhoneShell({
  ...
  const shell = (
    ...
    >
      ...
      {isSplit ? (
        <aside
          className="auth-shell-copy-column relative z-[1] hidden min-h-0 shrink-0 box-border lg:flex lg:min-h-dvh lg:w-1/2 lg:flex-col lg:items-stretch lg:justify-center lg:overflow-y-auto lg:overscroll-y-contain"
