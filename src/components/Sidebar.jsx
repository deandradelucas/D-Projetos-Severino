    ...
    <>
      ...
      <aside className={`sidebar ${menuAberto ? 'open' : ''}`}>
        ...
        <ul className="nav-menu">
          ...
          <div style={{ marginTop: '24px', marginBottom: '8px', paddingLeft: '16px', fontSize: '11px', fontWeight: 700, letterSpacing: '1px', color: 'var(--text-secondary)', textTransform: 'uppercase' }}>
            Administração
          </div>
          <li>
            <NavLink 
