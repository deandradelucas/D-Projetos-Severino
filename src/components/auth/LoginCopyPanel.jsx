 ...
 * Estrutura PAS + benefícios com destaque visual.
 */
...
const BENEFITS = [
  ...
  },
  {
    ...
    text: 'Registre gastos por mensagem, receba lembretes da agenda e use o assistente no celular.',
    whatsapp: true,
  },
  {
  ...
  return (
    <div className="auth-login-copy flex h-full flex-col justify-center">
      ...
      <p className="auth-login-copy__solution">
        O <strong>Severino</strong> reúne finanças, agenda, automação no WhatsApp e um assistente que responde com os
        seus dados — não com chute.
      </p>
